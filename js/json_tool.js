...
window.SINGLE_TAB = "  ";
window.imgPlus = "./img/plus.gif";
window.imgMinus = "./img/minus.gif";
...
function Process()
{
	...
	try
	{
		...
		if( braceType == "A" )
		{
			$id( "Canvas" ).innerHTML = "<PRE class='CodeContainer'>" + "<span class='ArrayBrace'>" + html.substring(26) + "</PRE>";
		}
		else
		{
			$id( "Canvas" ).innerHTML = "<PRE class='CodeContainer'>" + "<span class='ObjectBrace'>" + html.substring(27) + "</PRE>";
		}
	}
	catch( e )
	{
